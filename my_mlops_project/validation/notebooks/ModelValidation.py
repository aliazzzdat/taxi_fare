...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``my_mlops_project/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
dbutils.widgets.text("model_name", "ali_azzouz.mlops_dev.my-mlops-project-model", "Full (Three-Level) Model Name")
