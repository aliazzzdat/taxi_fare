...
# * custom_metrics_loader_function          - Specifies the name of the function in taxi-fare/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in taxi-fare/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text("validation_input", "ali_azzouz.mlops_dev.validation_table", "Validation Input")
...
dbutils.widgets.text("model_name", "ali_azzouz.mlops_dev.taxi-fare-model", "Full (Three-Level) Model Name")
